  ...
  return (
    <section id="inicio" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        <img
          src={heroBg}
          alt="Estúdio de gravação Liu Record"
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        ...
        <h1 className="font-display text-6xl md:text-8xl lg:text-9xl leading-none tracking-wider text-foreground mb-6 animate-fade-in-up opacity-0" style={{ animationDelay: "0.4s" }}>
          LIU <span className="text-gradient-gold">RECORD</span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in-up opacity-0" style={{ animationDelay: "0.8s" }}>
          <a
            href="#portfolio"
            className="inline-flex items-center gap-2 bg-gradient-gold text-primary-foreground font-body font-semibold px-8 py-4 rounded-md hover:opacity-90 transition-opacity"
          >
            <Play size={18} />
            Ouça Nossos Trabalhos
          </a>
          <a
            href="#contato"
            className="inline-flex items-center gap-2 border border-primary text-primary font-body font-semibold px-8 py-4 rounded-md hover:bg-primary hover:text-primary-foreground transition-colors"
          >
            Fale Conosco
          </a>
        </div>
